...
class UtilisateurRepository
{
    ...
    {
        $sql = "INSERT INTO utilisateur (nom, mdp, tel, adresse, date_de_naissance, role, etat_du_compte) 
                VALUES (:nom, :mdp, :tel, :adresse, :date_de_naissance, :role, :etat_du_compte)";
        $req = $this->connexionBdd->prepare($sql);
    ...
    public function modifierUtilisateur(Utilisateur $utilisateur)
    {
        $sql = "UPDATE utilisateur 
                SET nom = :nom, mdp = :mdp, tel = :tel, adresse = :adresse,
                    date_de_naissance = :date_de_naissance, role = :role,
