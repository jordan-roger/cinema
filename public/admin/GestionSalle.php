...
<head>
    ...
    <title>Gestion des salles – Ciné Lumière</title>
    <style>
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a class="nav-item active" href="GestionSalle.php">🏛️ Salles</a>
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="/cinema/src/traitement/admin/traitementGestionSalle.php">
                        <input type="hidden" name="action" value="ajouter">
                        <div class="form-row">
                            <div class="form-group">
                                <label>Nom</label>
                                <input type="text" name="nom" placeholder="Ex: Salle A" required>
                            </div>
                            <div class="form-group">
                                <label>Capacité</label>
                                <input type="number" name="capacite" min="20" max="500" placeholder="Ex: 100" required>
                            </div>
            ...
            <!-- Liste des salles -->
            <div class="card">
                <div class="card-header">Liste des salles (<?= count($toutesLesSalles) ?>)</div>
                <table>
                    <thead>
                    <tr>
                        <th>ID</th>
                    ...
                    <tbody>
                    <?php if (!empty($toutesLesSalles)): ?>
                        <?php foreach ($toutesLesSalles as $salle): ?>
                            <tr>
                                <td>#<?= htmlspecialchars((string) $salle->getIdSalle()) ?></td>
                                <td><strong><?= htmlspecialchars($salle->getNom()) ?></strong></td>
                                <td><?= htmlspecialchars((string) $salle->getCapacite()) ?> places</td>
                                <td>
                                ...
                                <td>
                                    <div class="actions">
                                        ...
                                        <?php if ($salle->getEtat() === 'disponible'): ?>
                                            <form method="post" action="/cinema/src/traitement/admin/traitementGestionSalle.php"
                                                  onsubmit="return confirm('Mettre cette salle en maintenance ?');">
                                        ...
                                        <?php else: ?>
                                            <form method="post" action="/cinema/src/traitement/admin/traitementGestionSalle.php"
                                                  onsubmit="return confirm('Remettre cette salle en service ?');">
                                                <input type="hidden" name="id_salle" value="<?= $salle->getIdSalle() ?>">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5" class="empty-msg">Aucune salle enregistrée.</td>
                        </tr>
                    <?php endif; ?>
                    </tbody>
                </table>
